        ...
        const app = createApp({
            ...
            methods: {
                ...
                addBranch() {
                    ...
                    axios.post('https://a.khmercleaningservice.us/api/branches', formData, {
                        headers: {
                ...
                updateBranch() {
                    ...
                    axios.post(`https://a.khmercleaningservice.us/api/branches/${this.form.id}?_method=PUT`, formData, {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    }).then(() => {
                ...
                deleteBranch(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            axios.delete(`https://a.khmercleaningservice.us/api/branches/${id}`)
                                .then(() => {
